...
// dashboard (Storage & Databases -> R2 -> javid-downloads-bybit), no git
...
// back to this project's own static assets (bybit-site/downloads/*.zip,
...
//   R2 bucket    -> variable name: DOWNLOADS_BUCKET (bucket_name: javid-downloads-bybit)
//   Assets binding -> ASSETS  (wrangler.jsonc "assets") — fallback only
//   D1 database  -> BOARD_DB (javid-board-db-bybit)
//
// To publish a new build: Cloudflare dashboard -> R2 -> javid-downloads-bybit
// -> upload/overwrite an object with EXACTLY the key name below (case
// sensitive, no version number in the filename):
//   JaviD_Future_Bot_Bybit_Windows.zip
//   JaviD_Future_Bot_Bybit_macOS.zip
//
...
const FILES = {
  windows: {
    r2Key: "JaviD_Future_Bot_Bybit_Windows.zip",
    assetPath: "downloads/JaviD_Future_Bot_Bybit_Windows.zip",
  },
  mac: {
