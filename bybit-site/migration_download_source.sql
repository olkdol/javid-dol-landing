-- Migration for the bg (Bybit) DB: javid-board-db-bybit
...
--
-- Run once from inside bybit-site/ (wrangler.jsonc lives in this folder):
--   cd bybit-site
--   npx wrangler d1 execute javid-board-db-bybit --remote --file=./migration_download_source.sql
--
