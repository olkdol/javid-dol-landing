-- Migration for the bg (Bitget) DB: javid-board-db-bitget
...
--
-- Run once from inside bitget-site/ (wrangler.jsonc lives in this folder):
--   cd bitget-site
--   npx wrangler d1 execute javid-board-db-bitget --remote --file=./migration_download_source.sql
--
